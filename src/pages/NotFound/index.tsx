...
const NotFound = () => {
  return (
    <div className="w-screen h-screen flex items-center justify-center dark:bg-black bg-main-color">
      <div className="flex flex-col gap-1 items-center font-roboto-condensed">
